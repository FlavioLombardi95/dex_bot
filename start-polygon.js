...
/**
 * Script di avvio per Polygon PoS Amoy Testnet
...
logger.info('✅ Configurazione Polygon PoS Amoy caricata');
        ...
        if (balance.lt(ethers.utils.parseEther('0.1'))) {
            logger.warn('⚠️ Saldo basso! Ottieni POL da: https://faucet.polygon.technology/');
        }
        ...
        logger.info('🎉 Bot avviato con successo su Polygon PoS Amoy!');
